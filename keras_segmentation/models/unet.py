...
from .shufflenet import shufflnet_encoder
...
def shufflnet_unet(n_classes, input_height=416, input_width=608, encoder_level=3):

    model = _unet(n_classes, shufflnet_encoder,
                  input_height=input_height, input_width=input_width)
    model.model_name = "shufflnet_unet"
    return model
